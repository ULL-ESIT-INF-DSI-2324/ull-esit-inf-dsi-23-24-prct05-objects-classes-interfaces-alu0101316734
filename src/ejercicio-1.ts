...
export class Gestor_de_Referncias_Bibliograficas {
  ...
  constructor(
    ...
    readonly palabras_claves: string[],
    readonly resumen: string,
    readonly fecha: Date,
    readonly n_paginas: number,
    readonly editorial: string,
  ) {
    this.recopilacion.push([
      titulo,
      autor,
      palabras_claves,
      resumen,
...
export class Articulo extends Gestor_de_Referncias_Bibliograficas {
  ...
  print(): void {
    ...
    console.table(
      recopilacionCompleta.map((trabajo) => [
        ...trabajo,
        this.volumen[0],
        this.revista[0],
      ]),
...
export class Congreso extends Gestor_de_Referncias_Bibliograficas {
  ...
  print(): void {
    const recopilacionCompleta = this.getrecopilacion();
    console.table(
      recopilacionCompleta.map((trabajo) => [...trabajo, this.dia]),
    );
  }
}
...
export class Libro extends Gestor_de_Referncias_Bibliograficas {
  ...
  print(): void {
    const recopilacionCompleta = this.getrecopilacion();
    console.table(
      recopilacionCompleta.map((trabajo) => [...trabajo, this.idiomas]),
    );
  }
}
